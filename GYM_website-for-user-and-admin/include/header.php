...
<head>
    ...
    <link rel="stylesheet" href="css/style2.css"/> <!-- Updated Stylesheet Link -->
</head>
<body>
<header class="header-section">
		...
		<div class="header-bottom">
			<a href="index.php" class="site-logo" style="color:#fff; font-weight:bold; font-size:26px; font-family: 'Montserrat', sans-serif;">
				GYM MS<br />
